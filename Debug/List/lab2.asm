...
; 0000 002C char  TAB[N] = {0,0,0,1,0,1,0,1};
; 0000 002D char tempX0 = 0;
; 0000 002E char tempX1 = 0;
; 0000 002F char tempX2 = 0;
; 0000 0030 
; 0000 0031 char index = 0;
; 0000 0032 
; 0000 0033 char input=0;
; 0000 0034 char output=0;//preluam valoarea din TAB[index]
; 0000 0035 
; 0000 0036 
; 0000 0037 // Clock Oscillator division factor: 1
; 0000 0038 #pragma optsize-
; 0000 0039 CLKPR=(1<<CLKPCE);
	SBIW R28,8
	LDI  R30,LOW(0)
	ST   Y,R30
	STD  Y+1,R30
...
;	output -> R20
	...
	LDI  R30,LOW(128)
	STS  97,R30
; 0000 003A CLKPR=(0<<CLKPCE) | (0<<CLKPS3) | (0<<CLKPS2) | (0<<CLKPS1) | (0<<CLKPS0);
	LDI  R30,LOW(0)
	STS  97,R30
...
; 0000 0080 // OC2A output: Disconnected
; 0000 0081 // OC2B output: Disconnected
; 0000 0082 ASSR=(0<<EXCLK) | (0<<AS2);
	STS  182,R30
; 0000 0083 TCCR2A=(0<<COM2A1) | (0<<COM2A0) | (0<<COM2B1) | (0<<COM2B0) | (0<<WGM21) | (0<<WGM20);
	STS  176,R30
; 0000 0084 TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	STS  177,R30
; 0000 0085 TCNT2=0x00;
	STS  178,R30
; 0000 0086 OCR2A=0x00;
	STS  179,R30
; 0000 0087 OCR2B=0x00;
	STS  180,R30
; 0000 0088 
; 0000 0089 // Timer/Counter 0 Interrupt(s) initialization
; 0000 008A TIMSK0=(0<<OCIE0B) | (0<<OCIE0A) | (1<<TOIE0);
	LDI  R30,LOW(1)
	STS  110,R30
; 0000 008B 
; 0000 008C // Timer/Counter 1 Interrupt(s) initialization
; 0000 008D TIMSK1=(0<<ICIE1) | (0<<OCIE1B) | (0<<OCIE1A) | (0<<TOIE1);
	LDI  R30,LOW(0)
	STS  111,R30
; 0000 008E 
; 0000 008F // Timer/Counter 2 Interrupt(s) initialization
; 0000 0090 TIMSK2=(0<<OCIE2B) | (0<<OCIE2A) | (0<<TOIE2);
	STS  112,R30
; 0000 0091 
...
; 0000 0097 // Interrupt on any change on pins PCINT8-15: Off
; 0000 0098 // Interrupt on any change on pins PCINT16-23: Off
; 0000 0099 // Interrupt on any change on pins PCINT24-31: Off
; 0000 009A EICRA=(0<<ISC21) | (0<<ISC20) | (0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  105,R30
; 0000 009B EIMSK=(0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x1D,R30
; 0000 009C PCICR=(0<<PCIE3) | (0<<PCIE2) | (0<<PCIE1) | (0<<PCIE0);
	STS  104,R30
; 0000 009D 
; 0000 009E // USART0 initialization
; 0000 009F // USART0 disabled
; 0000 00A0 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	STS  193,R30
; 0000 00A1 
; 0000 00A2 // USART1 initialization
; 0000 00A3 // USART1 disabled
; 0000 00A4 UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  201,R30
; 0000 00A5 
...
; 0000 00BC TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  188,R30
; 0000 00BD 
; 0000 00BE // Globally enable interrupts
; 0000 00BF #asm("sei")
	SEI
; 0000 00C0 
; 0000 00C1 while (1)
...
; 0000 00C4 input = PIND;
	IN   R21,9
; 0000 00C5 tempX0 = (input & maskX0) >> 7;//7= pozitia switch-pozitia unde vrem sa ajungem cu bitul
	MOV  R30,R21
	ANDI R30,LOW(0x80)
	LDI  R31,0
	RCALL __ASRW3
	RCALL __ASRW4
	MOV  R17,R30
; 0000 00C6 tempX1 = (input & maskX1) >> 2;// shiftam ca sa ajungem cu bitul pe pozitia lui naturala
	MOV  R30,R21
	ANDI R30,LOW(0x8)
	LDI  R31,0
	RCALL __ASRW2
	MOV  R16,R30
; 0000 00C7 tempX2 = (input & maskX2) >> 3;
	MOV  R30,R21
	ANDI R30,LOW(0x20)
	LDI  R31,0
	RCALL __ASRW3
	MOV  R19,R30
; 0000 00C8 
; 0000 00C9 index = tempX0 | tempX1 | tempX2;
	MOV  R30,R16
	OR   R30,R17
	OR   R30,R19
	MOV  R18,R30
; 0000 00CA 
; 0000 00CB output = TAB[index];
	LDI  R31,0
	MOVW R26,R28
	ADD  R26,R30
	ADC  R27,R31
	LD   R20,X
; 0000 00CC 
; 0000 00CD PORTB = output<<2;//aprindem ledul
	MOV  R30,R20
	LSL  R30
	LSL  R30
	OUT  0x5,R30
