...
; 0000 0020 TCNT0=0x3C;    //Porneste de la 60, de unde sa porneasca
	LDI  R30,LOW(60)
	OUT  0x26,R30
...
; 0000 002D 
; 0000 002E 
; 0000 002F // Clock Oscillator division factor: 1
...
; 0000 0040 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x4,R30
; 0000 0041 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0042 PORTB=(1<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (1<<PORTB3) | (1<<PORTB2) | (1<<PORTB1) | (1<<PORTB0);
	OUT  0x5,R30
; 0000 0043 
...
; 0000 0082 TIMSK0=(0<<OCIE0B) | (0<<OCIE0A) | (1<<TOIE0);
	LDI  R30,LOW(1)
	STS  110,R30
; 0000 0083 
...
; 0000 009B // USART1 disabled
; 0000 009C UCSR1B=(0<<RXCIE1) | (0<<TXCIE1) | (0<<UDRIE1) | (0<<RXEN1) | (0<<TXEN1) | (0<<UCSZ12) | (0<<RXB81) | (0<<TXB81);
	STS  201,R30
; 0000 009D 
...
; 0000 00A4 ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 00A5 ADCSRB=(0<<ACME);
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 00A6 // Digital input buffer on AIN0: On
; 0000 00A7 // Digital input buffer on AIN1: On
; 0000 00A8 DIDR1=(0<<AIN0D) | (0<<AIN1D);
	STS  127,R30
; 0000 00A9 
...
; 0000 00B4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	STS  188,R30
; 0000 00B5 
; 0000 00B6 // Globally enable interrupts
; 0000 00B7 #asm("sei")
	SEI
; 0000 00B8 
; 0000 00B9 while (1)
_0x3:
; 0000 00BA {
; 0000 00BB var = PIND.0;
	LDI  R30,0
	SBIC 0x9,0
	LDI  R30,1
	MOV  R17,R30
; 0000 00BC if(var==0)//verificam daca este activ
	CPI  R17,0
	BRNE _0x6
; 0000 00BD {
; 0000 00BE PORTB = 0xAA;
	LDI  R30,LOW(170)
	RJMP _0x9
; 0000 00BF }
; 0000 00C0 else
_0x6:
; 0000 00C1 PORTB=~0xAA;
	LDI  R30,LOW(85)
_0x9:
	OUT  0x5,R30
; 0000 00C2 }
